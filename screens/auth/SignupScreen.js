...
import header_logo from "../../assets/logo/artick.png";
...
const SignupScreen = ({ navigation }) => {
  ...
  const signUpHandle = () => {
    ...
    console.log('sign up')
       fetch(`${network.serverip}/users/signup`, requestOptions) //API call
          ...
          <View style={styles.screenNameContainer}>
            ...
            <View>
              <Text style={styles.screenNameParagraph}>
                Create your account on Artick to get an access to millions of products
              </Text>
            </View>
          </View>
